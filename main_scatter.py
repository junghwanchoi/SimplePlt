...
CFG_Common_PickMode = COMMON_PICKMODE_POINTRULER # legend:1, point ruler:2
...
class dlgChartType(QDialog):
    ...
    def __init__(self):
        ...
        # set focus
        self.tabWidget.setCurrentWidget(self.tabWidget.findChild(QWidget, "tab_scatter"))

        # stopping check box to get checked
        self.radioButton_plot.setCheckable(False)
        self.radioButton_scatter.setCheckable(True)
                                    ...
                                    if (len(lstLegendYValue_unique) > CFG_Legend_MaxMax):
                                        ...
                                        if YAttr in lstSelectedItemText:  # 현재 선택되어 있다면
                                            matplotlib_axes.scatter(
                                                x_data,
                                                y_data,
                                                s=CFG_Scatter_MarkerSize_Selected,
                                                alpha=CFG_Scatter_Alpha_Selected,
                                                picker=True, pickradius=5)  # 5 points tolerance
                                        else:
                                            matplotlib_axes.scatter(
                                                x_data,
                                                y_data,
                                                s=CFG_Scatter_MarkerSize_Unselected,
                                                alpha=CFG_Scatter_Alpha_Unselected,
                                                picker=True, pickradius=5)  # 5 points tolerance
